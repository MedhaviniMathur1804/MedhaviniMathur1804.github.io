    ...
    <main>
      ...
      <div className="content">
        <p style={{marginBottom: '20px', color: '#fff'}}>
          <Link href="https://github.com/MedhaviniMathur1804">GitHub</Link>{' '}
          • {' '}
          <Link href="https://github.com/MedhaviniMathur1804">LinkedIn</Link>{' '}
          • {' '}
          <Link href="https://github.com/MedhaviniMathur1804">Email</Link>
        </p>
